<?php
/*
Template Name: Portfolio 3 column : Masonry
*/
...
<div class="portfolio-start-display-section">
 <div class="container portfolio-filter portfolio-list-divider filter-portfolio-group-masnory">
    <ul>
		<?php if( ! empty($tax_terms) ) { ?>
            <li data-filter-masnory="*" class="selected"><span>All</span></li>
		<?php } ?>    
			<?php
                $i = 1;
            ...
            ?>
            <li data-filter-masnory=".<?php echo strtolower($cat_title_filter); ?>"><span><?php echo $cat_title; ?></span></li>
            <?php 
			 } 
			?> 
    </ul>
...
<div class="container portfolio-readjust-container">
		  <?php
			...
			if($wp_query->have_posts()) {
				if ( have_posts() ) {
					?>
                    <div class="isotope-container-masnory">
                    <?php 
					...
					?>
					<div class="col-md-4 col-sm-6 element-item  portfolio-section-records <?php foreach( $data_category as $val ) { echo  preg_replace("/[\s_]/", "-", strtolower($val)).' '; } ?>" >
                        <div class="portfolio-image"> 
                            <a href="<?php echo ($cutom_redirect_url?$cutom_redirect_url:get_the_permalink()); ?>"> 
                                <?php 
                                if ( has_post_thumbnail()) { 
                                    the_post_thumbnail(  'full', array( 'class' => 'hvr-float' ) );
                                } else {

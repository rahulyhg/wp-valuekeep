<?php
/*
Template Name: Portfolio 4 column : Masonry
*/
		  ...
		  <?php
			...
			if($wp_query->have_posts()) {
				if ( have_posts() ) {
					...
					?>
                <div class="col-md-3 col-sm-6 element-item  portfolio-section-records <?php foreach( $data_category as $val ) { echo  preg_replace("/[\s_]/", "-", strtolower($val)).' '; } ?>" >

...
/* dropdown-menus.twig */
class __TwigTemplate_4f94770529a5e043a55183e8f7e5fd64a6ebc64ce64af47eb257d549207a0dea extends Twig_Template
{
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["menu_key"] => $context["menu"]) {
            ...
            if (($context["menu_key"] == (isset($context["slug"]) ? $context["slug"] : null))) {
                ...
                // line 7
                echo "        ";
            } elseif (twig_in_filter($this->getAttribute($context["menu"], "slug", array()), twig_get_array_keys_filter($this->getAttribute((isset($context["settings"]) ? $context["settings"] : null), "menus", array())))) {
                // line 8
                echo "            ";
...
";
    ...
    {
        return new Twig_Source("", "dropdown-menus.twig", "/opt/bitnami/apache2/htdocs/wordpress/wp-content/plugins/sitepress-multilingual-cms/templates/language-switcher-admin-ui/dropdown-menus.twig");
    }
}

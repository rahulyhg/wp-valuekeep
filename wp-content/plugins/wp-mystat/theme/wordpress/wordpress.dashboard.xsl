    ...
    <div id="dashboard-widgets">
      <div class="postbox-container">
        ...
        <div class="postbox">
          ...
          <xsl:if test="//REPORT/MENU/ITEM[@code = 'geoCountry']/@disabled = ''">
        ...
        <div class="postbox">
          ...
          <xsl:if test="//REPORT/MENU/ITEM[@code = 'operatingSystem']/@disabled = ''">
            <div style="text-align:right;">
        ...
        <div class="postbox">
          ...
          <xsl:if test="//REPORT/MENU/ITEM[@code = 'robots']/@disabled = ''">
            <div style="text-align:right;">
      ...
      <div class="postbox-container">
        ...
        <div class="postbox">
          ...
          <xsl:if test="//REPORT/MENU/ITEM[@code = 'siteUsage']/@disabled = ''">
            <div style="text-align:right;">
        ...
        <div class="postbox">
          ...
          <xsl:if test="//REPORT/MENU/ITEM[@code = 'pageViewPerUser']/@disabled = ''">
            <div style="text-align:right;">
        ...
        <div class="postbox">
          ...
          <xsl:if test="//REPORT/MENU/ITEM[@code = 'referrer']/@disabled = ''">
            <div style="text-align:right;">

              ...
              <tr>
                ...
                <xsl:if test="$maxUniq&gt;0">
                  <td colspan="4" style="padding: 0 8px 3px 8px;">
                    <div class="progress"><div class="percent"><xsl:value-of select='format-number(DEVICE/@count * 100 div sum(//REPORT/INDICATORS/INDICATOR/DEVICE/@count),"#.##")'/>%</div><div class="bar">

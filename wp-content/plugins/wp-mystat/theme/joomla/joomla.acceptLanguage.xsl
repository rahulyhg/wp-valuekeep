    ...
    <table class="table table-striped table-bordered">
      ...
      <tfoot>
        ...
        <tr>
          ...
          <td align="center" style="text-align:center;"><b><xsl:value-of select="//REPORT/INDICATORS/NOTSET"/></b></td>
        </tr>
      </tfoot>
      <tbody>
          ...
          <xsl:if test="position() &gt; //REPORT/INDICATORS/PER_PAGE * (//REPORT/INDICATORS/CURRENT_PAGE - 1)">
            <xsl:if test="position() &lt;= //REPORT/INDICATORS/PER_PAGE * //REPORT/INDICATORS/CURRENT_PAGE">
              <tr>
                ...
                <td class="center" style="padding-top: 7px;padding-bottom: 0;">
                  <xsl:if test="LANGUAGE/@flag != ''">
                    <img src="{//REPORT/PATHTOCACHE}{LANGUAGE/@flag}"/>
                  </xsl:if>
                </td>
                <td>
                  ...
                  <td colspan="4" style="padding: 0px;">
                    <div class="progress">
                      <div class="bar">
                        ...
                        <xsl:value-of select='format-number(LANGUAGE/@count * 100 div sum(//REPORT/INDICATORS/INDICATOR/LANGUAGE/@count),"#.##")'/>%
                      </div>
                    </div>
                  </td>
                </xsl:if>

    ...
    <table class="table table-striped table-bordered">
      <thead>
        <tr>
          ...
          <th class="manage-column" style="text-align:center;width:100px;"><xsl:value-of select="//REPORT/TRANSLATE/REFERRER"/></th>
          <th class="manage-column" style="text-align:center;width:100px;"><xsl:value-of select="//REPORT/TRANSLATE/VIEW"/></th>
          <th class="manage-column" style="text-align:center;width:150px;"><xsl:value-of select="//REPORT/TRANSLATE/USERROBOT"/></th>
        </tr>
      </thead>
      <tfoot>
      </tfoot>

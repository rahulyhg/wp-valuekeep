    ...
    <table class="table table-striped table-bordered">
      <thead>
        <tr>
          ...
          <th class="manage-column" style="text-align:center;width:140px;"><xsl:value-of select="//REPORT/TRANSLATE/SITELINK"/></th>
          <th class="manage-column" style="text-align:center;width:170px;"><xsl:value-of select="//REPORT/TRANSLATE/VIEW"/></th>
          <th class="manage-column" style="text-align:center;width:80px;"><xsl:value-of select="//REPORT/TRANSLATE/USER"/></th>
        </tr>
      </thead>
      <tfoot>
        <tr>
          ...
          <xsl:if test="position() &gt; //REPORT/INDICATORS/PER_PAGE * (//REPORT/INDICATORS/CURRENT_PAGE - 1)">
            <xsl:if test="position() &lt;= //REPORT/INDICATORS/PER_PAGE * //REPORT/INDICATORS/CURRENT_PAGE">
              <tr>
                ...
                <td class="center">
                  <a onclick="jQuery('#extend{position()}').toggle();return false;" href="" class="btn btn-small"><xsl:value-of select="count(URI)"/> »</a>
                </td>
                <td class="center">

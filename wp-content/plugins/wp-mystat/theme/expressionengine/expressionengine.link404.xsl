    ...
    <table class="table table-striped table-bordered">
      <thead>
        <tr>
          ...
          <th class="manage-column" style="text-align:center;"><xsl:value-of select="//REPORT/TRANSLATE/REFERRER"/></th>
          <th class="manage-column" style="text-align:center;width:240px;"><xsl:value-of select="//REPORT/TRANSLATE/NOTFOUNDURI"/></th>
        </tr>
      </thead>
      <tfoot>
      </tfoot>

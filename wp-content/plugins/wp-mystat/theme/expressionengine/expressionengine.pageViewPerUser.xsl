<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform">
  ...
  <xsl:template name="content">
    ...
    <table class="table table-striped table-bordered">
      ...
      <tfoot>
        <xsl:if test="//REPORT/INDICATORS/ALL_USER&gt;0">
          <tr class="alternate">
            <th><xsl:value-of select="//REPORT/TRANSLATE/AVERAGE"/></th>
            <th style="text-align:center;"><xsl:value-of select="format-number(//REPORT/INDICATORS/TOTAL_VIEW div //REPORT/INDICATORS/ALL_USER,'#.##')"/></th>
          </tr>
        </xsl:if>
      </tfoot>
      <tbody>

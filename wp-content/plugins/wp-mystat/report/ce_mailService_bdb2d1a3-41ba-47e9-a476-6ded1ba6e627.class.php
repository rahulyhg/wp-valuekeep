...
class mystat_mailService{
  ...
  public function getName(){
    return $this->context->__('Mail services');
  }
  ...
  public function getXML(){
    ...
    $report['REPORT'] = Array(
      'TITLE' => $this->getName(),
      'SUBTITLE' => $this->context->__('List of online mail services, from which the users clicked through to your site'),
      'TRANSLATE' => Array(

...
//            
//            $translationdIDS = array( $parent_idES, $parent_idEN );
//            
//            foreach( $translationIDS as $translated_post_id){
//                $source_lang = 'pt-pt';
//                $trid = wpml_get_content_trid( 'post_manual_kb', $parent_id );
//
//                $sql = "UPDATE wp_icl_translations SET trid = '{$trid}', source_language_code = '{$source_lang}' WHERE element_id = '{$translated_post_id}' AND element_type='post_manual_kb'";
//                $wpdb->query( $sql ); 
//            }
//            
//            wp_trash_post( $idES  );
...
//            wp_trash_post( $fork  );
//        }
//        return (wp_update_post( $update ) && wp_publish_post( $parent_id ));
...
//        add_action('save_post', 'merge');
        ...
        return wp_publish_post( $parent_id );
    }

...
> #### Demos 
>
>[Content-Popup Video Gallery Demo](http://huge-it.com/wordpress-video-gallery-demo-1-content-popup/#plugin_demo_wrapper)
>
>[Content Video Slider Demo](http://huge-it.com/wordpress-video-gallery-demo-2-content-video-slider/#plugin_demo_wrapper)
>
>[Lightbox Gallery  Demo](http://huge-it.com/wordpress-video-gallery-demo-3-lightbox-video-gallery/#plugin_demo_wrapper)
>
>[Video Slider Demo](http://huge-it.com/wordpress-video-gallery-demo-4-video-slider/#plugin_demo_wrapper)
>
>[Thumbnails Demo](http://huge-it.com/wordpress-video-gallery-demo-5-thumbnails/#plugin_demo_wrapper)
>
>[Custom Thumbnails Demo](http://huge-it.com/wordpress-video-gallery-demo-6-custom-thumbnails/#plugin_demo_wrapper)
>
>[Blog Style View With pagination  Demo](http://huge-it.com/wordpress-video-gallery-demo-7-block-style-view/#plugin_demo_wrapper)

> #### FAQ & User Manual
>
>[FAQ](http://huge-it.com/wordpress-video-gallery-faq/)
>
>[User Manual](http://huge-it.com/wordpress-video-gallery/)
...
4. Upload [WordPress Video Gallery](https://wordpress.org/plugins/gallery-video/) ZIP file by choosing it from your computer
...
2. Search for 'Video Gallery Huge-IT'
...
2. Extract the **video-gallery** directory to your computer
3. Upload the **video-gallery** directory to the **/wp-content/plugins/** directory
...
1.  [WordPress Video Gallery view 1](http://huge-it.com/wordpress-video-gallery-demo-1-content-popup/#plugin_demo_wrapper) - Video Gallery / Content Popup
11.  [WordPress Video Gallery view 1](http://huge-it.com/wordpress-video-gallery-demo-1-content-popup/#plugin_demo_wrapper) - Video Gallery / Content Popup
2.  [WordPress Video Gallery view 2](http://huge-it.com/wordpress-video-gallery-demo-2-content-video-slider/#plugin_demo_wrapper) - Content Video Slider
3.  [WordPress Video Gallery view 3](http://huge-it.com/wordpress-video-gallery-demo-3-lightbox-video-gallery/#plugin_demo_wrapper) - Lightbox Video Gallery
32.  [WordPress Video Gallery view 3](http://huge-it.com/wordpress-video-gallery-demo-3-lightbox-video-gallery/#plugin_demo_wrapper) - Lightbox Video Gallery
4.  [WordPress Video Gallery view 4](http://huge-it.com/wordpress-video-gallery-demo-4-video-slider/#plugin_demo_wrapper) - Video Slider
5.  [WordPress Video Gallery view 5](http://huge-it.com/wordpress-video-gallery-demo-5-thumbnails/#plugin_demo_wrapper) - Video Gallery - Thumbnails
51.  [WordPress Video Gallery view 5](http://huge-it.com/wordpress-video-gallery-demo-5-thumbnails/#plugin_demo_wrapper) - Video Gallery - Thumbnails
52.  [WordPress Video Gallery view 5](http://huge-it.com/wordpress-video-gallery-demo-5-thumbnails/#plugin_demo_wrapper) - Video Gallery - Thumbnails
53.  [WordPress Video Gallery view 6](http://huge-it.com/wordpress-video-gallery-demo-6-custom-thumbnails/#plugin_demo_wrapper) - Video Gallery - Custom Thumbnails
54.  [WordPress Video Gallery view 7](http://huge-it.com/wordpress-video-gallery-demo-7-block-style-view/#plugin_demo_wrapper) - Video Gallery - Block Style View
...
64.  [WordPress Video Gallery Admin Page](https://wordpress.org/plugins/gallery-video/) - Video Gallery - Lightbox Options

== Frequently Asked Questions ==

= How to get the updated version? =

*  Pro users can get updated versions of plugin contacting us via the following email address:  info@huge-it.com.
*  Free version users of the Video Gallery plugin will find update notification on their WordPress admin panel.


= I have paid version, but doesn’t get the link or zip file. =

*  If you purchased Video Gallery plugin and didn’t get the file, or file was corrupt, contact us via the following email address: info@huge-it.com, drop your purchase Order Number, we will check and send you the zip file.
...
= Will I lose all my changes that I have made in free version if I update to the pro version? =

*  All kind of changes made in free version will remain, even if you delete plugin.


= How do I change New Video Gallery name? =

*  In order to change Video Gallery name just double click on its name (on top tabs), it will allow you to write whatever you wish.


= I have already purchased Multi-Site version, how do I upgrade it to Developer version, without buying again? =

*  If you have any pro version of our Video Gallery plugin and want to upgrade it, you do not need to buy the new Video Gallery once again, you only need to pay the price difference. For the following action simply contact info@huge-it.com or our online chat and we will help you to pay the difference.


= I have bought the commercial license, installed the zip file but the plugin seems to be still the free version, what to do? =

After installation of pro version, all your changes will be saved in General Options.
If you still see Free Version  notification after installation of pro version, in this case, you should do the following steps:

* 1) try to clean your cache files if this will not help
* 2) delete and install Video Gallery plugin again


= I have Video Gallery Multi-Sites and the Video Gallery plugin works only on one but not on the other sites as well, what to do? =

If you use Video Gallery Multi-Sites  (have a number of sites) when to install Video Gallery plugin on your main page, it will not work on the other pages.
If you want Video Gallery to work on all your websites, you should do the following steps:

* 1) deactivate plugin from the main page
* 2) go to the other pages and activate Video Gallery  there one by one
* 3) after all the pages the plugin will be activated, go back to your main page and activate Video Gallery


= How can I make gallery videos autoplay in lightbox? =

*  Plugin doesn’t provide this feature but contacting via this email info@huge-it.com you can order additional customization on this feature.


= Why I don't see thumbnail of video? =

*  If your gallery video is Vimeo, make sure that it allows sharing thumbnail image. The video shouldn't be private or unlisted. With other support on this kind of questions contact via the following email: info@huge-it.com.


= What to do if my Video Gallery has conflict with the other plugin or theme? =

*  Please contact with the support via the following email address: 


= How to remove related videos? =

*  This feature is not provided in the original plugin but contacting via the following email address info@huge-it.com you can order additional customization on this feature.


= I insert  the video link and the thumbnail image is not showing. =

*  Please check if your video is not private or unlisted, change the video link if the problem happens with all videos, contact support team info@huge-it.com.


= How to turn off related videos? =

*  It is recommended to ask our developers contacting via the following email:  info@huge-it.com. We will prepare a new file for you without related videos,  you  just need to inform us  what version of the Video Gallery you use and which view.


= May I add my own hosted videos? =

*  No, the Video Gallery is made to display only video links from Youtube Or Vimeo. 


= How do I disable related videos? =

*  Our company can provide you a free customization service. Contact us info@huge-it.com and ask to disable related videos, you will get a new plugin without related videos. For this request don't forget to mention: which version do you use, and on which view you need to disable related videos.


= How can I sort the videos? =
...
= Does Video Gallery limit uploaded video amount? =
*  No, in both free and pro version of Video Gallery you can add as many video links as you need.


= Why I can not add my Videos? =

*  The reason is properly in the type of the video, in videos should be from Youtube and Vimeo and most important is that the video should be public, and not private or unlisted. 


= Can I set the custom thumbnail? =

*  In Video Gallery plugin you on each video you can see Set Custom Thumbnail, which means that you can change the image of the gallery videos.  


= Can I add my own videos? =

*  No, you can not add your own videos, only from Youtube or Vimeo sources.


= Do you have setup guide? =

*  Yes, we have a tutorial video, you can see the Video Gallery setup demonstration here: [Wordpress Video Gallery](http://huge-it.com/wordpress-video-gallery/)


= Where can I see the main features of the plugin? =

*  About the main features, you can see here: [Wordpress Video Gallery](http://huge-it.com/wordpress-video-gallery/)
...
= Do you have some problem with the installation? =

*  Do not hesitate to contact the support team. They are ready to answer your questions, help you to solve the problems.


= Do I lose all my galleries created in free version when to upgrading the pro version? =

*  When you install pro version, all galleries created in free version will remain. Even if you uninstall or delete the old version.


= Can I add description for the gallery videos when they open with lightbox? =

*  No, it is not possible to show description, as the lightbox open as an image.


= Can I divide my gallery videos into pages? =

*  Pagination, Load More, and Show All displaying content.


= Can I do my own modifications in video gallery general options? =
...
Thanks to Oliveira Lima Jr for pointing it out.
...
= 1.6.98 =
*  Admin syntax error bug fixed.

= 1.6.97 =
*  Mirror bugs has been fixed.
...
= 1.6.8 =
*  Back end bugs has been fixed.

= 1.6.7 =
*  Lightbox size update.
...
= 1.5.5 =
*  Conflict bug has been fixed.

= 1.5.4 =
*  Some mirror Bugs has been fixed.

= 1.5.3 =
* Backend Bugs has been fixed.
...
= 1.0.6 =
*  Youtube links bugs has been fixed.
...
* Add video link:  Video links can be added from Youtube and Vimeo
* Hover/ Set Custom Thumbnail: On the video can be added another thumbnail image
* Title: Write a title for each gallery video
* Description: Write some information about gallery video content
* URL: You can add a link to another page that is related to the video
* Give an interesting name to the video gallery
* Select among 7 views to demonstrate the gallery videos 
* View Counter: This Button shows the number of video watching, when hover on it  you will see View Report PDF, click on it  to download the report in pdf file

### Inserting Created Video Gallery

After you created Video Gallery on the right side find 3 blocks

* 1.Usage: Here is located the shortcode. By Copy and Paste this shortcode can be inserted wherever you need in your post. Or even it is possible to add the shortcode automatically. In the post window just by pressing on Add Video Gallery button the shortcode will be inserted into the post.
* 2.Gallery Template include: Insert this code into your template, to make inserting the video gallery easy for using in custom location within theme.

### Step 2. General Options

In this section you can modify your Video Gallery in more details. It allows you to change the features for each view you use.

### 2.1 Video Gallery/Content popup

**Content Styles**
*Show Content In The Center: Thick to show the content in the center 

**Video element Styles**

* Video Thumbnail Behaviour: Resize or set the video as Natural
* Video Video-element Width: Specify preferable width
* Video element Height: Specify desired height of posted
* Video element Border width: Specify preferable width for surrounded border of the Video element
* Video element Border color: Select preferable color for surrounded border
* Video element's Video-image Overlay color: Select a color for the overlay on the video as you hold the mouse arrow on it
* Video element's Video-image Overlay Transparency: Determine preferable transparency degree for the video overlay
* Zoom image Style: Determine black or white color for zoom icon

**Popup Styles**

* Popup Background color: When open the gallery videos edit to set preferable background color for popup 
* Popup Overlay color: Choose preferable color for popup overlay when open the gallery videos
* Popup Overlay Transparency: Specify preferable degree of background transparency
* Popup Close Button Style: Edit what color for  “X” icon would you like to have 
...
* Link button Font color: Configure the preferable color for Link Button in popup
* Link Button Font Hover Color: Set more suitable font hover color for the link button
* Link button Background color: Specify preferable background color of the Link Button in popup
* Link Button Background Hover Color: Control the background hover color on link button

**Pagination Styles**

* Pagination Font Size: Define the font size
* Pagination Font Color: Select one of the colors for the pagination
* Pagination Icons Size: Define some size for the pagination icon 
* Pagination Icons Color: Select  the desired color for the pagination icon
* Pagination Position: Define the position of the pagination

**Video element Link button**

* Show Link Button On Element: Select to show “View More” button
* Link Button Text: You can change the “View More” button text and write something new
* Link Button Font Size: Choose preferable size of Link Button
* Link Button Font Color: Determine preferable color for the ink button 
* Link Button Background color: Determine preferable color for link background

**Video Element Title**

* Video element Title Font Size: For the video gallery edit preferable size of title font 
* Video element Title Font color: Edit preferable color of title 
* Video element Title Background color: Determine preferable color of title’s background

**Popup Title**

* Popup Title Font Size: Determine title size of the letters of popup
* Popup Title Font color: Configure preferable color for title in popup


**Popup Description**

* Show Description:  Select to show the description
* Description Font Size: Determine preferable size of description
* Description Font color: Set preferable color of description text


**Load More Styles**

* Load More Text: Change Load More text into an appropriate one 
* Load More Position: Make a choice among the 3 positions: Center, Right, Left
* Load More Font Size: Designate gallery video’s Load More button size
* Load More Font Color: You are free to set an amazing color for the video’s Load More button
* Load More Font Hover Color: Define preferable Load More font hover color
* Load More Button Color: Set suitable Load More button color 
* Load More Background Hover Color: Select Background Hover Color 
* Loading Animation 1: Decide which loading animation is better to show
...
* Slider Background Color: You can choose preferable color for slider field
* Arrow Icons Style: Specify black/white color of arrows in gallery slider
...
* Link button Text: Write a preferable text on Link Button
* Link button Font Size: Edit the size of the letters of the link text
* Link button Font color: Edit the color of the link text
* Link button Font Hover color: Edit the color of the link text while hovering the mouse on the button of the gallery videos
* Link button Background color: Determine preferable color for link field
* Link button Background Hover color: Choose a color for your link background while hovering on it

**Title**

* Title Font Size: Configure the preferable size of the letters of the title
* Title Font color: Configure the preferable color of the font


**Description**

* Show Description: Click to show the description for the videos
* Description Font Size: Specify preferable size of the description
* Description Font color: Choose a color for description text in your Content Video Slider view

### 2.3 Lightbox Video Gallery

**Content Styles**

*Show Content In The Center: Tick to show the content in the center

**Video image**

* Video Image Width:  Specify preferable size
* Video Image Border Width: Specify preferable width of surrounded borders
* Video Image Border Color: Configure your preferable color for border
* Border Radius:  Determine prefered radius of border corners

**Title**

* Title Font Size: Specify the size for font of the title
* Title Font color: Configure the preferable color for the title
* Title Font Hover Color: Configure the preferable color of the  title while hovering on it
* Title Background Color: Change the title background color, which comes up in closed position
* Title Background Transparency: For the gallery videos set the level of title background transparency 

**Load More Styles**

* Load More Text: Change Load More text into an appropriate one 
* Load More Position: Make a choice among the 3 positions: Center, Right, Left
* Load More Font Size: Designate Load More button size
* Load More Font Color: You are free to set an amazing color for the video’s Load More button
* Load More Font Hover Color: Define preferable Load More font hover color
* Load More Button Color: Set suitable Load More button color 
* Load More Background Hover Color: Select Background Hover Color 
...
* Pagination Font Size: Define the font size
* Pagination Font Color: Select one of the color 
* Pagination Icons Size: Define some size for the pagination icon 
* Pagination Icons Color: Select  desired color for the pagination icon
* Pagination Position: Define the position of the pagination
...
* Video Behaviour:  Choose Resize to stretch and fit your to the size of the Slider
* Slider Background color: Set preferable color of  the blank part of slider when images has its natural size
* Slideshow Border Size: Specify the size of the border in your slider
* Slideshow Border color:  For the choose prefered color for border
* Slideshow Border radius:  Determine preferable radius for the slider border
...
* Navigation Dots color: Choose the color for navigation dots of slider
* Navigation Active Dot colour: Determine preferable color of moving dots in slider
...
* Box background: Specify desired color of surrounded box of thumbnails  
* Box use shadow: Click if you would  like to have shadows in the box
* Box has background: Click to have background for the thumbnails

**Element Styles**

* Video Image Behavior: Click to determine behavior
* Video Image Width: Allows to specify preferable width of thumbnails
* Video Image Height: Allows to specify preferable height of thumbnails
* Video Image Border Width: Allows to specify preferable width of the border between thumbnails
* Video Image Border color: Determine preferable color of the border between thumbnails
* Border Radius:  Allows to specify preferable radius of the border
* Margin Video Image:  Allows to specify the distance between each thumbnails


**Title**

* Title Font Size: Specify preferable size of the text font 
* Title Font color: Determine preferable color of thumbnails title
* Overlay Background color: Determine the overlay color of the title
* Title Background Transparency: Specify the degree of background transparency
* Link text: Write desired text for the link
...
* Load More Position: Make a choice among the 3 positions: Center, Right, Left
* Load More Font Size: Designate Load More button size
* Load More Font Color: You are free to set an amazing color for the Load More button
* Load More Font Hover Color: Define preferable Load More font hover color
* Load More Button Color: Set suitable Load More button color 
* Load More Background Hover Color: Select Background Hover Color 
* Loading Animation 1: Decide which loading animation is better to show
...
* Image height: Set the height in the tape
* Image margin: Set the distance between each in the tape
* Image Justify: Select to make the width of all gallery video up to 100% in container. So all of them will fit the container of your theme, and tick off to bring each of them with its natural size
* Image Randomize: Select to show your videos randomly
* Opening With Animation: Choose to see the tape appearing animated
* Opening Animation Speed: Select the speed for the animation
...
* Container Width: Choose whole item container width
* Video Width: Choose width
* Video Height: Choose height
* Video Position in Container: Decide where to place
* Content Position: Set content position within page container
* Video Arrangement: Decide where to place the gallery video among description and title
* Space Between Containers: Set padding level between each item container
* Separator Line Style: Pick up one style for separational line, which will divide your items
* Separator Line Size:  Adjust separational line size
* Separator Line Color: Choose a color for separational line

**Title Styles**

* Show Title: Tick  if you need to display the title of the project
...
* Font Size: Change the font size for the description
* Font Color: Pick up font color for description text
...
* Pagination Font Size: Define the video’s font size
* Pagination Font Color: Select one of the color 
* Pagination Icons Size: Define some size for the pagination icon 
* Pagination Icons Color: Select  desired color for the pagination icon
* Pagination Position: Define the position of the pagination
...
* Load More Text: Change Load More text into an appropriate one 
* Load More Position: Make a choice among the 3 positions: Center, Right, Left
* Load More Font Size: Designate video’s Load More button size
* Load More Font Color: You are free to set an amazing color for the Load More button
* Load More Font Hover Color: Define preferable Load More font hover color
* Load More Button Color: Set suitable Load More button color 
* Load More Background Hover Color: Select Background Hover Color 
...
* The commercial version users can do unlimited customization when videos open with lightbox.

*   **Internationalization**

* Transition type: Select from three transition type for showing your content
* Lightbox Opening and Closing Speed: Set the lightbox opening and closing speed
* Show the title: Tick to show the title when to open your content
* Overlay transparency: Select the level of transparency for the overlay
* Auto-open: lightbox opens your videos automatically
* Overlayclose true and Esc Key close: Put checkmark to close the lightbox when to click on the background or Esc Key
* Keyboard Navigation: Turn on to navigate with keyboard  
* Loop content: If you select loop content, in this case, the 
* Videos will have endless circulation in lightbox
...
* Popup initial width and height: Choose the initial width and height when the videos open in lightbox 
...
* Popup position: Choose from 9 positions to open the videos with lightbox

###Main Features to Use

**Show Galley Content In The Center**

* In plugin you can show all your gallery in the center. You just need tick to Show Content In The Center, and your content will appear in the center.

###Element Styles

**Thumbnail behavior**

* Thumbnails behavior is proposed to choose the size of your elements on your page. The natural is normal size. Click on resize if you want your items to be a bit larger.

**Element Width and Height**

* Change the width and height of the elements to have a perfect size for the videos.

**Element border width and color**

* You can also have the border surrounding for gallery video image, and you can choose not only its width but the color as well.